...
@section('content')
    ...
    <div class="ArticleList">
                ...
                @if ($articles->isEmpty())
                    <p class="ArticleList__no-result-title">
                        @switch($request_type)
                            ...
                            @case('section')
                                Aucun article trouvé dans la rubrique<br class="ArticleList__br-large">
                                «&nbsp;{{ $slug }}&nbsp;»
                            @break
                            ...
                            @default
                                Aucun article trouvé pour la recherche<br class="ArticleList__br-large">
                                «&nbsp;{{ $slug }}&nbsp;»
                        @endswitch
                    </p>
                    ...
                    <p class="ArticleList__no-result-layus">
                        ...
                        <a href="mailto:documentation.mobilier@culture.gouv.fr">Contactez-nous</a> pour le soumettre. En
                        attendant nous vous invitons à explorer la <a href="{{ route('articles.home') }}">page
                            d’accueil</a>.
                    </p>
                @else
                    {{ $articles->total() }}
        ...
        <div class="ArticleList__pagination">
            {{ $articles->appends(['q' => $slug])->links('vendor.pagination.default') }}
        </div>
    </div>
