    ...
    <header class="Article__header" id="page-top">
        ...
        <div class="Article__cover-text">
                ...
                <h1 class="Article__h1">
                    <span class="Article__h1-inner">
                        ...
                        <div class="Article__reading-time">
                            <svg width="22" height="9" class="Article__reading-time-icon"
                                ...
                                <path
                                    d="M12.4435 4.5561C12.4435 3.57426 11.8466 2.77832 11.1102 2.77832C10.3738 2.77832 9.77686 3.57426 9.77686 4.5561"
                                    stroke="white" />
                                <path d="M1 3.55566H2.4" stroke="white" stroke-linecap="round"
                                    stroke-linejoin="round" />
                                <path d="M19.8906 3.55566H21.0017" stroke="white" stroke-linecap="round"
                                    stroke-linejoin="round" />
                            </svg>
                        ...
                        <svg width="20" height="27" viewBox="0 0 20 27" class="Article__arrow-down">
                            <path d="M18.7441 18.1543L9.97363 26.5" stroke="white" stroke-miterlimit="10"
                                stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M0.999268 18L9.97388 26.5" stroke="white" stroke-miterlimit="10"
                                stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M9.97365 26.5L9.97363 1" stroke="white" stroke-linecap="round"
                                stroke-linejoin="round" />
                        </svg>
                    </span>
                </h1>
            ...
            <figure class="Article__cover-image-container">
                <img src="{{ $item->image('cover', 'vertical') }}" alt="{{ $item->imageAltText('cover') }}"
            ...
            @if ($item->tags)
                <nav class="Article__tags">
                    @foreach ($item->tags as $tag)
                        <a href="{{ route('articles.by_tag', ['tag' => $tag->slug]) }}"
                            class="Article__tag">{{ $tag->name }}</a>
                    @endforeach
                </nav>
            @endif
