    ...
    <div class="EncycloHome">
        ...
        <section class="EncycloHome__header">
            ...
            <div class="EncyloHome__header_illu">
                <video src="/images/encyclo/encyclo_header_illu_smaller.m4v" poster="/images/encyclo/video_poster.jpg"
                    autoplay playsinline muted preload="auto" alt="Les savoir-faire du Mobilier National"
            ...
            <div class="EncycloHome__intro" data->
                <p class="EncycloHome__intro_lines">
                    ...
                    <span class="EncycloHome__line3"><a href="#rubrique-outils-techniques"
                            onclick="document.querySelector(this.getAttribute('href')).scrollIntoView({behavior: 'smooth'}); return false;">techniques</a><span
                            class="EncycloHome__comma">,</span></span>
        ...
        <section class="EncycloHome__une">
            ...
            <ul class="EncycloHome__cardstack EncycloHome__cardstack--featured_primary">
                @include('site._card', [
                    'article' => $featured_primary->first(),
        ...
        <section class="EncycloHome__latest">
            <div class="EncycloHome__latest_top">
                <p class="EncycloHome__latest_title">
                    Techniciens d’art, conservateurs, archivistes… du Mobilier national, vous proposent de nouvelles
                    histoires&nbsp;:
                </p>
            ...
            <section class="EncycloHome__section is-nth-section-{{ $loop->index }}">
                <div class="EncycloHome__section-inner">
                    <div class="EncycloHome__section_top" id="rubrique-{{ $s->slug }}">
                        ...
                        <a href="{{ route('articles.by_section', ['section' => $s->slug]) }}"
                            class="EncycloHome__section_link">Tout voir</a>
                    </div>
        ...
        <div class="EncycloHome__prefoot">
            <p class="EncycloHome__prefoot_aside">
                L’encyclopédie des savoir-faire s’enrichit régulièrement de nouveaux articles, n’hésitez pas à revenir, ou
                <a href="mailto:documentation.mobilier@culture.gouv.fr">nous écrire</a> pour une demande particulière. Belle
                découverte.
